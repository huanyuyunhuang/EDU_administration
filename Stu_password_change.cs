...
{
    public partial class Stu_password_change : Form
    {
        public Stu_password_change()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string select_SQL = "Select * from student_login where ID = '" + textBox1.Text + "' and Pass_word='" + textBox3.Text + "'";
            ...
            {
                Data_Base.Open();
                string insert_SQL_1 = "update student_login set Pass_word = " + textBox2.Text + " where ID = '" + textBox1.Text + "'";
