...
namespace jiaowuguanlijiemian
{
    public partial class new_student : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Data_Base.Open();
            string insert_SQL = "insert into student values('" + textBox1.Text+"','"+textBox2.Text+"','"+textBox3.Text+"','"+textBox4.Text+"')";
            ...
            Data_Base.Open();
            string insert_SQL_1 = "insert into student_login values('" + textBox1.Text + "','" + textBox5.Text + "')";
